...
class CreateSongDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { title: { required: true, type: () => String, minLength: 1, maxLength: 200 }, artist: { required: false, type: () => String }, originalKey: { required: true, type: () => String }, bpm: { required: false, type: () => Number }, tags: { required: false, type: () => [String] }, version: { required: false, type: () => require("./create-song.dto").CreateSongVersionDto } };
    }
}
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: CreateSongVersionDto }),
    (0, class_validator_1.IsOptional)(),

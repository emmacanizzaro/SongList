...
const create_song_dto_1 = require("../domain/create-song.dto");
...
let SongsController = class SongsController {
    ...
    findAll(churchId, search, page = '1', pageSize = '20') {
        return this.songsService.findAll(churchId, search, parseInt(page, 10) || 1, parseInt(pageSize, 10) || 20);
    }
    findOne(churchId, id) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Listar canciones (con búsqueda y paginación)' }),

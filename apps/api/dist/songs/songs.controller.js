...
let SongsController = class SongsController {
  ...
  addVersion(churchId, songId, type, targetKey, notes) {
    return this.songsService.addVersion(
      churchId,
      songId,
      type,
      targetKey,
...
__decorate(
  [
    ...
    __metadata("design:paramtypes", [
      String,
      String,
      create_song_dto_1.CreateSongDto,
    ]),
...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: "Obtener canción con todas las versiones",
    }),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, (0, tenant_decorator_1.CurrentTenant)()),
...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: "Transposición en vivo (sin guardar)",
    }),

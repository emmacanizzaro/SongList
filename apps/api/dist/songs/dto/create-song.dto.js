...
class CreateSongVersionDto {
  static _OPENAPI_METADATA_FACTORY() {
    return {
      ...
      lyricsChords: { required: true, type: () => String },
...
__decorate(
  ...
  CreateSongVersionDto.prototype,
  "type",
  void 0,
);
__decorate(
...
class CreateSongDto {
  static _OPENAPI_METADATA_FACTORY() {
    return {
      ...
      artist: { required: false, type: () => String, maxLength: 100 },
      originalKey: { required: true, type: () => String },
      bpm: { required: false, type: () => Number, minimum: 40, maximum: 300 },
      tags: { required: false, type: () => [String] },
      version: {
        required: false,
        type: () => require("./create-song.dto").CreateSongVersionDto,
      },
    };
  }
}
...
__decorate(
  [
    (0, swagger_1.ApiPropertyOptional)({
      description: "Versión original de la canción",
    }),
    (0, class_validator_1.IsOptional)(),

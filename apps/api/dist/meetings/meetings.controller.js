...
let MeetingsController = class MeetingsController {
  ...
  addSong(churchId, meetingId, songId, keyOverride, notes) {
    return this.meetingsService.addSong(
      churchId,
      meetingId,
      songId,
      keyOverride,
  ...
  reorderSongs(churchId, meetingId, orderedSongIds) {
    return this.meetingsService.reorderSongs(
      churchId,
      meetingId,
      orderedSongIds,
    );
  ...
  assign(churchId, meetingId, userId, instrumentId, notes) {
    return this.meetingsService.assignMusician(
      churchId,
      meetingId,
      userId,
      instrumentId,
  ...
  unassign(churchId, meetingId, assignmentId) {
    return this.meetingsService.unassignMusician(
      churchId,
      meetingId,
      assignmentId,
    );
...
__decorate(
  [
    ...
    __metadata("design:paramtypes", [
      String,
      String,
      create_meeting_dto_1.CreateMeetingDto,
    ]),
...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: "Obtener reunión con canciones y asignaciones",
    }),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, (0, tenant_decorator_1.CurrentTenant)()),
...
__decorate(
  [
    ...
    (0, roles_decorator_1.Roles)(client_1.MemberRole.EDITOR),
    (0, swagger_1.ApiOperation)({
      summary: "Reordenar canciones de la reunión",
    }),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, (0, tenant_decorator_1.CurrentTenant)()),
    __param(1, (0, common_1.Param)("id")),
...
__decorate(
  [
    ...
    __param(3, (0, common_1.Body)("instrumentId")),
    __param(4, (0, common_1.Body)("notes")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String, String]),
    __metadata("design:returntype", void 0),
...
__decorate(
  [
    ...
    (0, roles_decorator_1.Roles)(client_1.MemberRole.EDITOR),
    (0, swagger_1.ApiOperation)({
      summary: "Generar link público de solo lectura",
    }),
...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: "Ver reunión compartida (sin autenticación)",
    }),
    openapi.ApiResponse({ status: 200, type: Object }),
  ...
  PublicMeetingsController.prototype,
  "findByToken",
  null,
);

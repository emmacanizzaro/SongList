...
const create_meeting_dto_1 = require("../domain/create-meeting.dto");
...
let MeetingsController = class MeetingsController {
    ...
    assign(churchId, meetingId, userId, instrumentId, notes) {
        return this.meetingsService.assignMusician(churchId, meetingId, userId, instrumentId, notes);
    }
    unassign(churchId, meetingId, assignmentId) {
        return this.meetingsService.unassignMusician(churchId, meetingId, assignmentId);
    }

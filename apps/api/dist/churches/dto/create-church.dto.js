...
exports.CreateChurchDto = void 0;
const openapi = require("@nestjs/swagger");
const class_validator_1 = require("class-validator");
const swagger_1 = require("@nestjs/swagger");
class CreateChurchDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, minLength: 2, maxLength: 100 }, description: { required: false, type: () => String, maxLength: 500 }, logoUrl: { required: false, type: () => String } };
    }
}
...
__decorate([
    ...
    __metadata("design:type", String)
], CreateChurchDto.prototype, "logoUrl", void 0);
//# sourceMappingURL=create-church.dto.js.map
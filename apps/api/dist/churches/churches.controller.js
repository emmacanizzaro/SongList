...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: "Obtener iglesia actual del usuario",
    }),
...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: "Actualizar datos de la iglesia (solo ADMIN)",
    }),
    ...
    __metadata("design:paramtypes", [
      String,
      create_church_dto_1.CreateChurchDto,
    ]),
    __metadata("design:returntype", void 0),
  ],
  ChurchesController.prototype,
...
__decorate(
  [
    ...
    (0, roles_decorator_1.Roles)(client_1.MemberRole.ADMIN),
    (0, swagger_1.ApiOperation)({
      summary: "Generar enlace de invitación (solo ADMIN)",
    }),
...
__decorate(
  [
    ...
    (0, roles_decorator_1.Roles)(client_1.MemberRole.ADMIN),
    (0, swagger_1.ApiOperation)({
      summary: "Cambiar rol de un miembro (solo ADMIN)",
    }),
    openapi.ApiResponse({ status: 200 }),
    __param(0, (0, tenant_decorator_1.CurrentTenant)()),
...
__decorate(
  [
    ...
    (0, swagger_1.ApiOperation)({
      summary: "Consultar invitación por token (público)",
    }),
    openapi.ApiResponse({ status: 200 }),
  ...
  PublicChurchInvitesController.prototype,
  "getInviteByToken",
  null,
);
exports.PublicChurchInvitesController = PublicChurchInvitesController =
